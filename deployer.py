...
try:
    ...
    music_time_cmds.append(
        {"command": "connect_spotify", "caption": "Connect Spotify"})
    music_time_cmds.append(
        {"command": "disconnect_spotify", "caption": "Disconnect Spotify"})
    music_time_cmds.append(
    ...
    music_time_cmds.append(
        {"command": "connect_slack", "caption": "Connect slack"})
    music_time_cmds.append(
        {"command": "disconnect_slack", "caption": "Disconnect slack"})
