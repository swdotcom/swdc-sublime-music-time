...
access_token = "BQCIgYu44S3nQ5JHooln8LDEI_kzwssRSPmWLk_FuPYVAvHAhzeNN84CcJmmtDa1-EuaxH6Y-aQ-u02NxhX0ApAA2tGTEM6QaekOLyfgkhMJESpFqyYJtsxhHsfVAwm4WPSs4yUiexB3TCC4mmwEKkyfD3CA-eInGTrtDCErpuS-UkgM6IdWiAV28AcfgEuT1dT8V8Qucow5zDX7EwWupa1PL9qapCJhiN75WZnRE7k7KdRpTIGYTYQ0v11ktXlfTYtX8l_DYT0HzdrAfcB-UlUKrWLuqZMh4KgNW2OuWQ"
filter_type = "Running"
current_track = "Diane Young"
...
class SongsInputHandler(sublime_plugin.ListInputHandler):
    ...
    def list_items(self):
        ...
        if len(recommendation_data) == 0 or recommendation_data[0] != filter_type:
            ...
            if tracks == []:
                sublime.error_message("No songs found for this category")
